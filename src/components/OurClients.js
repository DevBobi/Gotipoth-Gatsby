...
const OurClients = () => {
    return (
        <div className="mx-auto py-5 px-4 w-full max-w-7xl bg-white text-gray-800">
            <div className="flex flex-col items-center space-y-12">
                ...
                <div className="grid grid-cols-6 gap-3">
                    ...
                    {/* ::Partner 1 -> ALL */}
                    <div className="col-span-3 sm:col-span-2 lg:col-span-1 py-5 px-5 flex justify-center items-center ">
